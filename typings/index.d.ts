...
declare module 'Poru' {
  export class Poru extends EventEmitter {
    ...
    public on(
      event: 'nodeConnect' | 'nodeReconnect',
      listener: (node: Object) => void,
    ): this;

    public on(
      event: 'nodeDisconnect',
      listener: (event: any, node: Object) => void,
    ): this;

    public on(
      event: 'nodeError',
      listener: (node: Object, event: any) => void,
    ): this;

    public on(
      event: 'queueEnd',
      listener: (
        player: typeof EventEmitter | any,
        track: Object,
        data: Object | any,
      ) => void,
    ): this;
    ...
    public on(
      event: 'socketClosed',
      listener: (player: typeof EventEmitter | any, data: Object | any) => void,
    ): this;
...
export class Node {
  constructor(
    manager: typeof EventEmitter | any,
    options: object,
    node: object,
  );
